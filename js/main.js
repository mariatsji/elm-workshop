...
var _mariatsji$elm_workshop$Main$customStyleOptions = _elm_lang$core$Native_Utils.update(
...
var _mariatsji$elm_workshop$Main$main = A2(
	_xarvh$elm_slides$Slides$app,
	_mariatsji$elm_workshop$Main$customStyleOptions,
	{
		ctor: '::',
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mariatsji$elm_workshop$Main$main !== 'undefined') {
    _mariatsji$elm_workshop$Main$main(Elm['Main'], 'Main', undefined);
}
